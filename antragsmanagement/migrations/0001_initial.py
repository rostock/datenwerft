    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('authority', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='antragsmanagement.authority')),
                ('cleanupevent_request', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='antragsmanagement.cleanupeventrequest')),
            ],
            options={
        ...
        migrations.AddField(
            ...
            field=models.ManyToManyField(blank=True, editable=False, through='antragsmanagement.CleanupEventResponsibilities', to='antragsmanagement.authority', verbose_name='Zuständigkeit(en)'),
        ),
        migrations.CreateModel(
        ...
        migrations.AddField(
            model_name='cleanupeventrequest',
            name='status',
            field=models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='antragsmanagement.codelistrequeststatus', verbose_name='Status'),
        ),
        migrations.AddField(
            model_name='cleanupeventrequest',
            name='requester',
            field=models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='antragsmanagement.requester', verbose_name='Antragsteller:in'),
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('equipments', models.ManyToManyField(blank=True, db_table='cleanupevent_details_equipments', to='antragsmanagement.cleanupeventcodelistequipment', verbose_name='benötigte Ausstattung(en)')),

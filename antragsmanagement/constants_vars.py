...
REQUESTERS = getattr(
  settings, 'ANTRAGSMANAGEMENT_REQUESTER_GROUP_NAME', 'antragsmanagement_requester'
)
AUTHORITIES = getattr(
  settings,
...
ADMINS = getattr(settings, 'ANTRAGSMANAGEMENT_ADMIN_GROUP_NAME', 'antragsmanagement_admin')

...
class EmailTest(DefaultModelTestCase):
  ...
  model = Email
  attributes_values_db_create = {'key': get_random_string(length=12), 'body': VALID_TEXT}
  attributes_values_db_update = {'key': get_random_string(length=12)}
...
class RequesterTest(DefaultModelTestCase):
  ...
  attributes_values_db_update = {'organization': VALID_STRING}
...
class CleanupEventRequestTest(DefaultModelTestCase):
  ...
  def setUpTestData(cls):
    ...
    cls.attributes_values_db_update = {'status': status2}
...
class CleanupEventEventTest(DefaultModelTestCase):
  ...
  def setUpTestData(cls):
    ...
    cls.attributes_values_db_update = {'to_date': VALID_DATE}
    cls.test_object = cls.model.objects.create(**cls.attributes_values_db_create)
...
class CleanupEventVenueTest(DefaultModelTestCase):
  ...
  def setUpTestData(cls):
    ...
    cls.attributes_values_db_update = {'cleanupevent_request': cleanupevent_request2}
    cls.test_object = cls.model.objects.create(**cls.attributes_values_db_create)
...
class CleanupEventDetailsTest(DefaultModelTestCase):
  ...
  def setUpTestData(cls):
    ...
    cls.attributes_values_db_update = {'waste_types_annotation': VALID_STRING}
    cls.test_object = cls.model.objects.create(**cls.attributes_values_db_create)
...
class CleanupEventRequestCommentTest(DefaultModelTestCase):
  ...
  def setUpTestData(cls):
    ...
    cls.attributes_values_db_update = {'send_to_requester': True}
    cls.test_object = cls.model.objects.create(**cls.attributes_values_db_create)

    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True, verbose_name='Erstellung')),
                ('updated_at', models.DateTimeField(auto_now=True, verbose_name='letzte Änderung')),
                ('denotation', models.CharField(max_length=255, validators=[django.core.validators.RegexValidator(message='Texte dürfen keine Akute (´) enthalten. Stattdessen muss der typographisch korrekte Apostroph (’) verwendet werden.', regex='^(?!.*´).*$'), django.core.validators.RegexValidator(message='Texte dürfen keine doppelten Schreibmaschinensatz-Anführungszeichen (") enthalten. Stattdessen müssen die typographisch korrekten Anführungszeichen („“) verwendet werden.', regex='^(?!.*\\").*$'), django.core.validators.RegexValidator(message="Texte dürfen keine einfachen Schreibmaschinensatz-Anführungszeichen (') enthalten. Stattdessen muss der typographisch korrekte Apostroph(’) verwendet werden.", regex="^(?!.*\\').*$"), django.core.validators.RegexValidator(message='Texte dürfen keine doppelten Leerzeichen und/oder Zeilenumbrüche enthalten.', regex='^(?!.*  ).*$'), django.core.validators.RegexValidator(message='Texte dürfen keine Gravis (`) enthalten. Stattdessen muss der typographisch korrekte Apostroph (’) verwendet werden.', regex='^(?!.*`).*$')], verbose_name='Bezeichnung')),
                ('emission_point', django.contrib.gis.db.models.fields.PointField(srid=25833, verbose_name='Emissionsort')),
                ('address', models.UUIDField(blank=True, null=True, verbose_name='Adresse')),
                ...
                ('dms_link', models.CharField(blank=True, max_length=16, null=True, validators=[django.core.validators.RegexValidator(message='Der <strong><em>d.3</em></strong>-Vorgang muss folgendes Format aufweisen (Beispiel): 552.6#04-004/008', regex='^[0-9]{3}\\.[0-9]#[0-9]{2}-[0-9]{3}\\/[0-9]{3}$')], verbose_name=' d.3')),
                ('licensee', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='bemas.organization', verbose_name='Betreiberin')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('immission_point', django.contrib.gis.db.models.fields.PointField(srid=25833, verbose_name='Immissionsort')),
                ('address', models.UUIDField(blank=True, null=True, verbose_name='Adresse')),
                ...
                ('complainers_organizations', models.ManyToManyField(db_table='complainers_organizations', to='bemas.organization')),
                ('complainers_persons', models.ManyToManyField(db_table='complainers_persons', to='bemas.person')),
                ('originator', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='bemas.originator', verbose_name='Verursacher')),
                ('status', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='bemas.status', verbose_name='Bearbeitungsstatus')),
                ('type_of_immission', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='bemas.typeofimmission', verbose_name='Immissionsart')),
            ],
            options={

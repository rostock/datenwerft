...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            ...
            field=models.ManyToManyField(db_table='complainers_organizations', to='bemas.organization', verbose_name='Beschwerdeführerin'),
        ),
        migrations.AddField(
            model_name='complaint',
            name='complainers_persons',
            field=models.ManyToManyField(db_table='complainers_persons', to='bemas.person', verbose_name='Beschwerdeführer:in'),
        ),
        migrations.AddField(
            model_name='complaint',
            name='originator',

    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('complainers_organizations', models.ManyToManyField(db_table='complainers_organizations', to='bemas.organization', verbose_name='Beschwerdeführerin')),
                ('complainers_persons', models.ManyToManyField(db_table='complainers_persons', to='bemas.person', verbose_name='Beschwerdeführer:in')),

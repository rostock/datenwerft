...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('bemas', '0008_remove_address_address_unique_and_more'),
    ]
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('address', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='bemas.address', verbose_name='Anschrift')),
            ],
            options={

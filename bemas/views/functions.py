...
def create_log_entry(model, object_pk, action, content, user):
  """
  creates new log entry based on passed affected model, affected (target) object, action and user
...
def generate_foreign_key_objects_list(foreign_key_objects, formation_hint=None):
  """
  generates an HTML list of passed foreign key objects and returns it

  :param foreign_key_objects: foreign key objects
  :param formation_hint: formation hint
  :return: HTML list of passed foreign key objects
  """
  object_list = ''
...
def generate_foreign_key_link(foreign_key_field, source_object, link_text=None):
  """
  generates a foreign key link by means of passed foreign key field and source object
  and returns it

  :param foreign_key_field: foreign key field
  :param source_object: source object
  :param link_text: link text
  :return: foreign key link, generated by means of passed foreign key field and source object
  """
...
def generate_foreign_key_link_simplified(target_model, target_object, link_text=None):
  """
  generates a foreign key link by means of passed target model and target object and returns it

  :param target_model: target model
  :param target_object: target object
  :param link_text: link text
  :return: foreign key link, generated by means of passed target model and target object
  """
  if not link_text:
...
def set_log_action_and_content(model, curr_object, changed_attribute, cleaned_data=None):
  ...
  based on passed model, object and changed data attribute, and returns them
  ...
  based on passed model, object and changed data attribute
  """
...
def transform_activity_objects(activity_objects):
  """
  returns representations for a template of passed activity objects

  :param activity_objects: activity objects
  :return: representations for a template of passed activity objects
  """

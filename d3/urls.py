...
from d3.views.views import (
  DokumentenBearbeitenView,
  DokumentenErstellenView,
  DownloadView,
  FetchMetaDataRequestView,
  ListeDateienView,
)
...
for model in models:
  ...
  urlpatterns.append(
    path(
      ...
      view=datenmodel_permission_required(model_name_lower)(
        ErstelleVorgangView.as_view(
          model=Vorgang, template_name='d3/vorgang-form.html', datenmanagement_model=model_name
        )
      ),
  ...
  urlpatterns.append(
    path(
      ...
      view=datenmodel_permission_required(model_name_lower)(
        ListeDateienView.as_view(datenmanagement_model=model_name)
      ),
  ...
  urlpatterns.append(
    path(
      ...
      view=datenmodel_permission_required(model_name_lower)(
        DownloadView.as_view(datenmanagement_model=model_name)
      ),
  ...
  urlpatterns.append(
    path(
      ...
      view=datenmodel_permission_required(model_name_lower)(
        DokumentenErstellenView.as_view(datenmanagement_model=model_name)
      ),
  ...
  urlpatterns.append(
    path(
      ...
      view=datenmodel_permission_required(model_name_lower)(
        DokumentenBearbeitenView.as_view(datenmanagement_model=model_name)
      ),

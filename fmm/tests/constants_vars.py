...
VALID_POLYGON_VIEW_A = (
  'POLYGON((307845 6005103, 307845 6005105, 307847 6005105, 307847 6005103, 307845 6005103))'
)
VALID_POLYGON_VIEW_B = (
  'POLYGON((308745 6001503, 308745 6001505, 308747 6001505, 308747 6001503, 308745 6001503))'
)

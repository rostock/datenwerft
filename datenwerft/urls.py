...
from metadatenmanagement import urls as metadatenmanagement_urls
...
api_urlpatterns += metadatenmanagement_urls.api_urlpatterns
...
urlpatterns = [
  ...
  # ...Metadatenmanagement app
  path('metadatenmanagement/', view=include('metadatenmanagement.urls')),
  # ...Django-RQ

...
class App(Base, BaseMetadata):
  ...
  tags = models.ManyToManyField(Tag, blank=True, verbose_name=_('Schlagwort/Schlagwörter'))
  publishers = models.ManyToManyField(Contact, verbose_name=_('Herausgeber:in(nen)'))
  maintainers = models.ManyToManyField(Contact, verbose_name=_('Betreuer:in(nen)'))
  legal = models.ForeignKey(
    Legal, on_delete=models.PROTECT, related_name='app_legals', verbose_name=_('rechtliche Information')
  )
  languages = models.ManyToManyField(Language, verbose_name=_('Sprache(n)'))
  topics = models.ManyToManyField('Topic', blank=True, verbose_name=_('Datenthema/-themen'))
  services = models.ManyToManyField('Service', blank=True, verbose_name=_('Service(s)'))
  datasets = models.ManyToManyField('Dataset', blank=True, verbose_name=_('Datensatz/Datensätze'))
  assetsets = models.ManyToManyField('Assetset', blank=True, verbose_name=_('Asset-Sammlung(en)'))
  repositories = models.ManyToManyField('Repository', blank=True, verbose_name=_('Speicherort(e)'))
...
class Topic(Base, BaseMetadata):
  ...
  title = models.CharField(validators=standard_validators, verbose_name=_('Titel'))
  tags = models.ManyToManyField(Tag, blank=True, verbose_name=_('Schlagwort/Schlagwörter'))
  categories = models.ManyToManyField(DatathemeCategory, verbose_name=_('Kategorie(n)'))
  hvd_category = models.ForeignKey(
    HvdCategory, on_delete=models.PROTECT, blank=True, null=True, related_name='topic_hvd_categories', verbose_name=_('HVD-Kategorie')
  )
  services = models.ManyToManyField('Service', blank=True, verbose_name=_('Service(s)'))
  datasets = models.ManyToManyField('Dataset', blank=True, verbose_name=_('Datensatz/Datensätze'))
  assetsets = models.ManyToManyField('Assetset', blank=True, verbose_name=_('Asset-Sammlung(en)'))
...
class Service(Base, BaseMetadata, SpatioTemporalMetadata):
  ...
  additional_crs = models.ManyToManyField(
    CrsSet, blank=True, verbose_name=_('zusätzliche(s) Koordinatenreferenzsystem(e)')
  )
  spatial_reference = models.ForeignKey(
    ...
    verbose_name=_('räumlicher Bezug'),
  )
  publishers = models.ManyToManyField(Contact, verbose_name=_('Herausgeber:in(nen)'))
  maintainers = models.ManyToManyField(Contact, verbose_name=_('Betreuer:in(nen)'))
  legal = models.ForeignKey(
    Legal, on_delete=models.PROTECT, related_name='service_legals', verbose_name=_('rechtliche Information')
  )
  type = models.CharField(choices=ServiceType.choices, verbose_name=_('Typ'))
  inspire_theme = models.ForeignKey(
    InspireTheme, on_delete=models.PROTECT, blank=True, null=True, related_name='service_inspire_themes', verbose_name=_('INSPIRE-Thema')
  )
  inspire_spatial_scope = models.ForeignKey(
    ...
    verbose_name=_('räumlicher INSPIRE-Bezugsbereich'),
  )
  ...
  language = models.ForeignKey(Language, on_delete=models.PROTECT, related_name='service_languages', verbose_name=_('Sprache'))
  charset = models.ForeignKey(Charset, on_delete=models.PROTECT, related_name='service_charsets', verbose_name=_('Zeichensatz'))
  datasets = models.ManyToManyField('Dataset', blank=True, verbose_name=_('Datensatz/Datensätze'))
  assetsets = models.ManyToManyField('Assetset', blank=True, verbose_name=_('Asset-Sammlung(en)'))
  repositories = models.ManyToManyField('Repository', blank=True, verbose_name=_('Speicherort(e)'))
...
class Dataset(Base, BaseMetadata, CreationalMetadata, SpatioTemporalMetadata):
  ...
  maintainers = models.ManyToManyField(Contact, verbose_name=_('Betreuer:in(nen)'))
  legal = models.ForeignKey(
    Legal, on_delete=models.PROTECT, related_name='dataset_legals', verbose_name=_('rechtliche Information')
  )
  inspire_theme = models.ForeignKey(
    InspireTheme, on_delete=models.PROTECT, blank=True, null=True, related_name='dataset_inspire_themes', verbose_name=_('INSPIRE-Thema')
  )
  inspire_spatial_scope = models.ForeignKey(
    InspireSpatialScope,
    on_delete=models.PROTECT,
  ...
  language = models.ForeignKey(Language, on_delete=models.PROTECT, related_name='dataset_languages', verbose_name=_('Sprache'))
  charset = models.ForeignKey(Charset, on_delete=models.PROTECT, related_name='dataset_charsets', verbose_name=_('Zeichensatz'))
  data_type = models.ForeignKey(DataType, on_delete=models.PROTECT, related_name='dataset_data_types', verbose_name=_('Datentyp'))
  ...
  hash_type = models.ForeignKey(
    HashType, on_delete=models.PROTECT, related_name='dataset_hash_types', verbose_name=_('Typ des Hashes')
  )
  hash = models.CharField(validators=standard_validators, verbose_name=_('Hash-Wert'))
  byte_size = models.PositiveIntegerField(verbose_name=_('Größe in der Einheit Byte (B)'))
...
class Assetset(Base, BaseMetadata, CreationalMetadata):
  ...
  maintainers = models.ManyToManyField(Contact, verbose_name=_('Betreuer:in(nen)'))
  legal = models.ForeignKey(
    Legal, on_delete=models.PROTECT, related_name='assetset_legals', verbose_name=_('rechtliche Information')
  )
  type = models.ForeignKey(AssetType, on_delete=models.PROTECT, related_name='assetset_types', verbose_name=_('Typ'))
  repositories = models.ManyToManyField('Repository', blank=True, verbose_name=_('Speicherort(e)'))
...
class Source(Base, BaseMetadata):
  ...
  import_frequency = models.ForeignKey(
    Frequency, on_delete=models.PROTECT, related_name='source_import_frequencies', verbose_name=_('Importhäufigkeit')
  )
  authors = models.ManyToManyField(Contact, verbose_name=_('Autor(en):in(nen)'))
  ...
  data_type = models.ForeignKey(DataType, on_delete=models.PROTECT, related_name='source_data_types', verbose_name=_('Datentyp'))
  spatial_representation_type = models.ForeignKey(
    SpatialRepresentationType,
    on_delete=models.PROTECT,
    blank=True,
...
class Repository(Base, BaseMetadata, CreationalMetadata):
  ...
  data_type = models.ForeignKey(DataType, on_delete=models.PROTECT, related_name='repository_data_types', verbose_name=_('Datentyp'))
  spatial_representation_type = models.ForeignKey(
    SpatialRepresentationType,
    on_delete=models.PROTECT,
    blank=True,
  ...
  source = models.ForeignKey(
    Source, on_delete=models.PROTECT, blank=True, null=True, related_name='repository_sources', verbose_name=_('Datenquelle')
  )

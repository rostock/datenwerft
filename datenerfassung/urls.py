...
urlpatterns = [
    ...
    url(r'^accounts/logout/$', logout, {'template_name': '_registration/logout.html'}, name = 'logout'),
    url(r'^accounts/login/$', login, {'template_name': '_registration/login.html'}, name = 'login'),

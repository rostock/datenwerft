...
for model in app_models:
    ...
    urlpatterns.append(url(regex + r'change/(?P<pk>.*)/$', permission_required('datenmanagement.change_' + model_name_lower, 'datenmanagement.delete_' + model_name_lower, 'datenmanagement.view_' + model_name_lower)(views.DataChangeView.as_view(model = model, template_name = 'datenmanagement/dataform.html', success_url = reverse_lazy('datenmanagement:' + model_name + 'start'))), name = model_name + 'change'))
    urlpatterns.append(url(regex + r'delete/(?P<pk>.*)/$', permission_required('datenmanagement.delete_' + model_name_lower)(views.DataDeleteView.as_view(model = model, template_name = 'datenmanagement/datadelete.html', success_url = reverse_lazy('datenmanagement:' + model_name + 'start'))), name = model_name + 'delete'))
    urlpatterns.append(url(regex + r'deleteimmediately/(?P<pk>.*)/$', permission_required('datenmanagement.delete_' + model_name_lower)(views.delete_object_immediately), name = model_name + 'deleteimmediately'))
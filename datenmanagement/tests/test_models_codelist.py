from datenmanagement.models import Adressen, Strassen, Inoffizielle_Strassen, Gemeindeteile, \
  ...
  Ansprechpartner_Baustellen, Arten_Adressunsicherheiten, Arten_Baudenkmale, Arten_Durchlaesse, \
  ...
  Auftraggeber_Baustellen, Ausfuehrungen_Haltestellenkataster, \
...
class ArtenBaudenkmaleTest(DefaultCodelistTestCase):
  """

...
from datenmanagement.models import Abfallbehaelter, Adressen, Adressunsicherheiten, \
  ...
  Arten_Adressunsicherheiten, Arten_Erdwaermesonden, Arten_Fahrradabstellanlagen, \
  ...
  Arten_Toiletten, Arten_Wege, Aufteilungsplaene_Wohnungseigentumsgesetz, Baudenkmale, \
  ...
  FairTrade, Feldsportanlagen, Feuerwachen, Fliessgewaesser, Geh_Radwegereinigung, Gemeindeteile, \
  Geraetespielanlagen, Geschlechter_Kadaverfunde, Gutachterfotos, Haefen, Hausnummern, Hospize, \
  Hundetoiletten, Hydranten, Kadaverfunde, Kategorien_Strassen, Kindertagespflegeeinrichtungen, \
  Kinder_Jugendbetreuung, Kunst_im_oeffentlichen_Raum, Ladestationen_Elektrofahrzeuge, \
...
class AdressunsicherheitenTest(DefaultSimpleModelTestCase):
  """
...
class GehRadwegereinigungTest(DefaultSimpleModelTestCase):
  """
...
class StrassenSimpleTest(DefaultSimpleModelTestCase):
  """
  Straßen
  """
...
class StrassenreinigungTest(DefaultSimpleModelTestCase):
  """
  Straßenreinigung
  """

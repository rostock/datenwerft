...
from datenmanagement.models import Abfallbehaelter, Adressen, Altersklassen_Kadaverfunde, \
  ...
  Status_Poller, Strassen, Strassen_Simple, Thalasso_Kurwege, Tierseuchen, Toiletten, \
  Trinkwassernotbrunnen, Typen_Kleinklaeranlagen, Vereine, Verkaufstellen_Angelberechtigungen, \
